...
public class SunshineSyncTask {
    ...
    private static final String KEY_PATH = "/WATCH_FACE";
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                Cursor cursor = context.getContentResolver().query(WeatherContract.WeatherEntry.CONTENT_URI,
                        new String[]{WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,
                ...
                if (cursor != null){
                    ...
                    if (result.isSuccess()){
                        ...
                        Log.d("TAG", "data is sending to wearable");
                    }else {
                        Log.e("TAG", result.getErrorMessage());
                    }
                }else {
                    Log.e("TAG", "cursor crashed");
                }
